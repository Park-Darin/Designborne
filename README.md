# Designborne: A Rogue-like Game Project
...
###### 3. Unlock the Gate("=") with Old key : You can use unlocked gate to transition to another map, where new challenges await. (Shown in option d in screenshot below)
